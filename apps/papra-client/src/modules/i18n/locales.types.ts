...
export type LocaleKeys =
  ...
  | 'layout.menu.account'
  | 'layout.sidenav.all-organizations'
  | 'layout.sidenav.github-repository'
  | 'layout.sidenav.bluesky'
  | 'layout.sidenav.search'
  | 'layout.sidenav.import-document'
  | 'layout.sidenav.account-settings'
  | 'layout.sidenav.api-keys'
  | 'layout.sidenav.language'
  | 'layout.sidenav.logout'
